#ifndef CAL_PIDECAYGENERATOR_H
#define CAL_PIDECAYGENERATOR_H
...
private:
    ...
    std::vector<Particle> decayPiOnTwoPhotons();//pi0 -> gamma + gamma
    std::vector<Particle> decayPiOnElectrPositrAndPhoton();// pi0 -> e+ + e- + gamma
};


#endif //CAL_PIDECAYGENERATOR_H
